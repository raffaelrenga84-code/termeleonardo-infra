...
export function importa(intestazioni: string[], righe: string[][]): { categorie: CategoriaImportata[]; articoli: ArticoloImportato[]; scartate: number } {
