...
function piedeEN(firma, testoChiusura) {
  ...
  <tr><td align="center" style="padding:20px 36px 26px 36px;">
    ...
    <div style="font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:20px;color:#8C8578;padding-top:10px;">
      Via Monteortone 46 &middot; 35037 Monteortone di Teolo (PD), Italy &middot; <a href="https://www.hoteltermeleonardo.com" target="_blank" style="color:#8C8578;text-decoration:underline;">hoteltermeleonardo.com</a>
    </div>
  </td></tr>
