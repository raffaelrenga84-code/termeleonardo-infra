...
| dove | cosa |
|---|---|
| `leonardo.fidra.cloud` | legge l'offerta aperta (`extractor.js`), le disponibilita', i numeri di camera, le scadenze, le fatture, e manda gli articoli al POS (`fidra-articoli.js`) |
