...
Deno.test('la reception vede prima le richieste, poi gli arrivi, poi i buoni', () => {
  assertEquals(
    ...
    ['richieste', 'arrivi', 'dayspaOggi', 'emetti', 'elenco', 'verifica', 'dayspaDisponibilita', 'dayspaPrenotazioni', 'posMenu', 'posTavoli', 'posPersonale', 'posAddebiti', 'posGiornata', 'posFasce', 'privacy'],
  );
});
...
Deno.test('la spa vede prima le richieste e gli arrivi, senza la scheda che il server le rifiuta', () => {
  assertEquals(
    ...
    ['richieste', 'arrivi', 'dayspaOggi', 'elenco', 'verifica', 'dayspaDisponibilita', 'dayspaPrenotazioni', 'posMenu', 'posTavoli', 'posPersonale', 'posAddebiti', 'posGiornata', 'posFasce', 'privacy'],
  );
});
