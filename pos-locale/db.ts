...
create table if not exists pos_articolo (
  nomi text, descrizioni text, allergeni text, orari text, per_ospiti integer not null default 1, vegano integer not null default 0, vegetariano integer not null default 0,
